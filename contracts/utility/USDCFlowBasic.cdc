...
/// This is a basic version of the USDCFlow contract without
/// any pieces that connect to the VM bridge.
/// It is deployed to the emulator by default and is only meant to be used there
...
access(all) contract USDCFlow: FungibleToken, ViewResolver {
    ...
    access(all) resource Minter {
        ...
        /// Function for the admin to mint tokens
        ...
        /// Function for the admin to burn tokens
